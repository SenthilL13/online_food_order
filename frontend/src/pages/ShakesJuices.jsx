...
function ShakesJuices() {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        const filteredItems = response.data.filter(item => item.category === "shakes&juices");
  ...
  return (
    <Container className='text-light' id='shakes-juices'>
